...
import type { MeetingData } from "~/stores/NewMeetingStore";
...
onBeforeMount(() => {
  ...
  updateMeetingInfoTimer = setInterval(updateMeetingInfo, 2000);
});
        ...
        <div class="w-full absolute bottom-0 px-3 md:py-8 bg-white border-t rounded-tr-2xl rounded-tl-2xl flex flex-col overflow-hidden
          ...
          <div class="h-full overflow-auto">
            <div class=" pb-8">
              ...
              <input type="text" v-model="meetingData.title" @input="(_) => props.saveMeetingData()" name="title"
                maxlength="100"
              ...
              <div class="flex flex-col gap-2 mt-2 text-sm">
                ...
                <div v-for=" slots in meetingData.selectedTimes"
